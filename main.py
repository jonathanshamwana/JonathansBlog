...
def register():
    ...
    if User.query.filter_by(email=email).first():
        flash("There's already an account with that email. Log in!", "error")
...
def login():
    ...
    return render_template("login.html", form=form, already=already, current_user=current_user)
...
def show_post(post_id):
    ...
    return render_template("post.html", current_user=current_user, post=requested_post, form=form, gravatar=gravatar)
